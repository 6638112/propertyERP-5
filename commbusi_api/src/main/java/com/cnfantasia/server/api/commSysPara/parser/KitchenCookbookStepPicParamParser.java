/**   
* Filename:    KitchenCookbookStepPicParamParser.java   
* @version:    1.0  
 ...
 * 2014年7月28日       shiyl             1.0             1.0 Version
 */
public class KitchenCookbookStepPicParamParser extends AbstractSysParamParser{
	...
	protected String getSysParamKey() {
		return SysParamKey.KITCHEN_COOKBOOK_STEPPIC_BASEPATH;
	}
