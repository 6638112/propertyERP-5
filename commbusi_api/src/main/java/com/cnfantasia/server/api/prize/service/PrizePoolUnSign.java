/**   
* Filename:    PrizePoolUnSign.java   
* @version:    1.0  
* Create at:   2015年1月16日 上午10:18:49   
* Description:  
*   
 ...
 * 2015年1月16日       shiyl             1.0             1.0 Version
 */
public class PrizePoolUnSign extends AbstractPrizePool{
...
//		}
		{//根据时间获取对应规则
			...
			prizeRuleGenerateConfig = prizeRuleManager.getPrizeRuleGenerateTimeConfig(nowTime,ConfigType.Time_UnSign);
		}
	...
	public Long getPrizeCountTotal() {
		Long prizeTotalCount = commonPrizeService.getPrizeCountUnSigned().longValue();//查询总奖池数量
	...
	protected List<PrizeRecord> getPrizeRecordCurrMonth() {
		//查询已签约小区的抽奖记录
		List<PrizeRecord> donePrizeRecList = prizeDao.selectPrizeRecordCurrMonthUnSign();
