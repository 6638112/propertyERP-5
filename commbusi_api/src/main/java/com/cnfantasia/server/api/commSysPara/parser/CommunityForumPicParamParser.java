/**   
* Filename:    CommunityForumPicParamParser.java   
* @version:    1.0  
 ...
 * 2014年7月22日       shiyl             1.0             1.0 Version
 */
public class CommunityForumPicParamParser extends AbstractSysParamParser{
	...
	protected String getSysParamKey() {
		return SysParamKey.CommunityForum_Pic_BasePath;
	}
