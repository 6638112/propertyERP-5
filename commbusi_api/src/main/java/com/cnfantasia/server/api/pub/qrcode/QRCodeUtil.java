...
* @version:    1.0  
* Create at:   2014年5月14日 上午11:01:06   
* Description:  
*   
* Modification History:   
* Date        Author      Version     Description   
* ----------------------------------------------------------------- 
* 2014年5月14日    shiyl      1.0         1.0 Version   
*/
package com.cnfantasia.server.api.pub.qrcode;
 ...
 * @version:    1.0.0
 * Create at:   2014年5月14日 上午11:01:06
 * Description:利用zxing开源工具生成二维码QRCode
 *
 * Modification History:
 * Date           Author           Version           Description
 * ------------------------------------------------------------------
...
public class QRCodeUtil {
	...
	public static void main(String[] args) throws UnsupportedEncodingException {
		...
		hints.put(EncodeHintType.MARGIN, 0);//白色边框的处理 0表示无
//		encode(new String("whfwefw中文乱码fjkejklwf"), file,filePostfix, BarcodeFormat.QR_CODE, 100, 100, hints);
		encode(new String("whfwefw中文乱码fjkejklwf"), file,filePostfix, BarcodeFormat.QR_CODE, 100, 100, hints);
		decode(file);
	}
