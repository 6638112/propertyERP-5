...
public class LocationConverter {
    ...
    public static Location wgs84ToGcj02(Location location) {
        return gcj02Encrypt(Double.valueOf(location.getLat()), Double.valueOf(location.getLng()));
    }
    ...
    public static Location gcj02ToWgs84(Location location) {
        return gcj02Decrypt(Double.valueOf(location.getLat()), Double.valueOf(location.getLng()));
    }
    ...
    public static Location wgs84ToBd09(Location location) {
        Location gcj02Pt = gcj02Encrypt(Double.valueOf(location.getLat()), Double.valueOf(location.getLng()));
        return bd09Encrypt(Double.valueOf(gcj02Pt.getLat()), Double.valueOf(gcj02Pt.getLng()));
    }
    ...
    public static Location gcj02ToBd09(Location location) {
        return bd09Encrypt(Double.valueOf(location.getLat()), Double.valueOf(location.getLng()));
    }
    ...
    public static Location bd09ToGcj02(Location location) {
        return bd09Decrypt(Double.valueOf(location.getLat()), Double.valueOf(location.getLng()));
    }
    ...
    public static Location bd09ToWgs84(Location location) {
        ...
        return gcj02Decrypt(Double.valueOf(gcj02.getLat()), Double.valueOf(gcj02.getLng()));
    }
    ...
    private static Location gcj02Encrypt(double ggLat, double ggLon) {
        ...
        if (outOfChina(ggLat, ggLon)) {
            resPoint.setLat(String.valueOf(ggLat));
            resPoint.setLng(String.valueOf(ggLon));
            return resPoint;
        }
        ...
        resPoint.setLat(String.valueOf(mgLat));
        resPoint.setLng(String.valueOf(mgLon));
        return resPoint;
    }

    private static Location gcj02Decrypt(double gjLat, double gjLon) {
        Location gPt = gcj02Encrypt(gjLat, gjLon);
        double dLon = Double.valueOf(gPt.getLng()) - gjLon;
        double dLat = Double.valueOf(gPt.getLat()) - gjLat;
        Location pt = new Location();
        pt.setLat(String.valueOf(gjLat - dLat));
        pt.setLng(String.valueOf(gjLon - dLon));
        return pt;
    }
    ...
    private static Location bd09Decrypt(double bdLat, double bdLon) {
        ...
        gcjPt.setLng(String.valueOf(z * Math.cos(theta)));
        gcjPt.setLat(String.valueOf(z * Math.sin(theta)));
        return gcjPt;
    }
    ...
    private static Location bd09Encrypt(double ggLat, double ggLon) {
        ...
        double z = Math.sqrt(x * x + y * y) + 0.00002 * Math.sin(y * Math.PI);
        double theta = Math.atan2(y, x) + 0.000003 * Math.cos(x * Math.PI);
        bdPt.setLng(String.valueOf(z * Math.cos(theta) + 0.0065));
        bdPt.setLat(String.valueOf(z * Math.sin(theta) + 0.006));
        return bdPt;
    }
