...
public class LoginDict {
    ...
    public static class ValiCodeGetType {
        ...
        /** 绑定私家车 */
        public static final Integer BIND_CAR = 5;
        
        /** 物业代扣卡充值 */
        public static final Integer Property_Card_Charge = 6;

        /** 校验手机号是否在用时使用*/
        public static final Integer COMMON_PHONE_CHECK  = 7;

        /** 商户端使用*/
        public static final Integer EBUY_MERCHANT = 8;
    }
    ...
    public static class Regist3rd_Type {
        ...
        /** 微信轻应用 */
        public static final Integer WEI_XIN_LIGHT_APP = 6;
    }
    ...
    public static class AccountType {
        ...
        /** 微信轻应用 */
        public static final Long WEI_XIN_LIGHT_APP = 8L;
        // /** 手动注册账号 */
        // public static final Long HANDEL_ACC = 99L;
    }
     ...
     * 账号创建方式=={"2":"绑定创建"}
     */
    public static class LoginNo_CreateType {
        /** "1":"普通登录注册创建"" */
        public static final Integer CommLogIn = 1;
        /** "2":"绑定创建"" */
        public static final Integer Bind = 2;
        /** "3":"微信unionId绑定创建"" */
        public static final Integer WeiXinUnionIdBind = 3;
    }
