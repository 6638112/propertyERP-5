...
<section class="main-box">
	<c:forEach items="${sa.sadList }" var="sad" varStatus="status">
		<c:if test="${sad.jumpType == 0}">
			<div>
				<img class="bgloading" src="../images/pixel.gif" data-original="${sad.picUrl }?x-oss-process=image/resize,w_640/format,jpg/quality,q_90/interlace,1" />
			</div>
		</c:if>
...
<script src="../js/act.common.js?20171206"></script>
