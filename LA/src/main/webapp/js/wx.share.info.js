function setShareInfo(newOptions){
	var shareInfo = {
			...
			link: '',	// 分享链接
			imgToFriend: $('#sharePath').data('path') + '/commonimages/jfqlogo_share.png',	// 分享图标
			imgToQuan: $('#sharePath').data('path') + '/commonimages/jfqlogo_share.png'	// 分享图标
	}
