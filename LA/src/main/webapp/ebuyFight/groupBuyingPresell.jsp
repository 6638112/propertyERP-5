...
<script>
	$(function(){
		...
		$('#groupBuyBtn').click(function(){
			location.href="../cart/getLaFightOrderMsg.do?productId="+fightProductId;
		});
...
//统一微信分享风格 
var shareTitle = '<%=ShareConstant.shareFightTitle%>';
...
wx.ready(function(){
	...
	wx.onMenuShareTimeline({
	    title: '${fightProduct.name}', // 分享标题
	    link: shareUrl, // 分享链接
	   	imgUrl: $("div.swiper-wrapper.imgLoading.my-gallery img").eq(0).attr("src"), // 分享图标
	    success: function () { 
	        // 用户确认分享后执行的回调函数
	    },
	    cancel: function () { 
