...
<div class="info">
    <form class="inputform" action="<%=basePath%>/ebuyFightSupplyMerchant/updFightMerchant.html" method="post">
        <h2>自提点修改</h2>
        <table class="info-list-02 mtop20" border="0" cellpadding="0" cellspacing="1">
            <input type="hidden" name="ebuyFightSupplyMerchant.id" value="${dto.fightMerchantId}">
            <tr>
                <td width="20%"><div class="list-name"><span class="red">*</span> 自提点名称：</div></td>
                <td><input type="text" value="${dto.ebuyFightSupplyMerchant.name}" name="ebuyFightSupplyMerchant.name" class="input_text w300" maxlength="30" datatype="*4-30" nullmsg="请完善自提点信息" errormsg="自提点名称为4-30个字符" /></td>
            </tr>

            <tr class="search-input">
                <td><div class="list-name"><span class="red">*</span> 自提点城市：</div></td>
                <td>
                    <input type="text" value="${dto.cityName}" maxlength="8" id="city" class="input_text w120 pp" placeholder="请输入关键字" />
                ...
                <td>
                    <ul class="address-list search-box city-box">
                        <li class="posrelative address-selected address-selected-4"
                            data-class="address-selected-4"><span class="address-name" data-itemid="${dto.cityId}">${dto.cityName}</span>
                        </li>
                    </ul>
                </td>
            </tr>
            <tr class="city-con">
                ...
                <td>
                    <ul class="address-list selected-box city-box">
                        ...
                        <li class="posrelative address-selected address-selected-4"
                            data-class="address-selected-4"><span class="address-name">${dto.cityName}</span>
                            <div class="icon-delete"></div>
                            <input type="hidden" id="cityId" value="${dto.cityId}">
                        </li>
                    </ul>
                    <input type="hidden" value="1" class="select-input input_text w80 dsn" datatype="*" nullmsg="请选择城市！" />
                </td>
            </tr>
            ...
            <tr class="city-con">
                ...
                <td>
                    ...
                    <input type="hidden" value="${dto.groupBuildingCount}" class="select-input input_text w80 dsn" datatype="*" nullmsg="请选择小区！" />
                </td>
            </tr>

            <tr>
                <td><div class="list-name"><span class="red">*</span> 自提点地址：</div></td>
                <td><input type="text" value="${dto.ebuyFightSupplyMerchant.delivAddress}" name="ebuyFightSupplyMerchant.delivAddress" class="input_text w300" maxlength="30" datatype="*4-30" nullmsg="请完善自提点信息" errormsg="自提点地址为4-30个字符" /></td>
            </tr>
            <tr>
                <td><div class="list-name"><span class="red">*</span> 手机号码：</div></td>
                <td><input type="text" value="${dto.ebuyFightSupplyMerchant.tel}" name="ebuyFightSupplyMerchant.tel" class="input_text pp w120" datatype="m" nullmsg="请完善拼购信息" errormsg="请填写正确的手机号码格式" /></td>
            </tr>
        </table>
...
<script type="text/javascript">
    $(function(){
        ...
        var $addressSelectedLi = $('.address-selected.dsn'),
                ...
                selectCountNum = ${dto.groupBuildingCount},
                selectCityCountNum = 1,
                realNum;
