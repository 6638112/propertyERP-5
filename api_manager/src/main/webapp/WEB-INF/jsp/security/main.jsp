        ...
        <ul class="menu-all">
         		...
         		<li class="parent collapsed"><a class="menu-01" href="#" >物业模块</a>
                  <ul class="collapsed">
                      <li class="parent collapsed"><a href="#" >物业公告管理</a>
                          <ul>
                              <li class="child"><a  id="entryGoods" href="javascript:void(0)" onclick="addTab('物业公告管理','<%=basePath%>/notice/index.html');">物业公告管理</a></li>
                          </ul>
                      </li>
                  </ul>
              </li>
           <%}}%>
            ...
            <li class="parent collapsed"><a class="menu-01" href="#">电商模块</a>
                <%-- <ul class="collapsed">
                    <li><a href="javascript:void(0)" onclick="addTab('订单管理','<%=basePath%>/order/index.html')">订单管理</a></li>
                </ul> --%>
                <ul>
                    <li class="child"><a  id="entryGoods" href="javascript:void(0)" onclick="addTab('订单管理','<%=basePath%>/order/index.html');">订单管理</a></li>
                </ul>
            </li>
        </ul>
	</div>
