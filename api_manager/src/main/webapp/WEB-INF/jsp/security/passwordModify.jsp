                ...
                <div class="add-user">
                    <table border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        ...
                        <td><input id="oldPassword" type="password" class="input_text pp" value="" name="oldPassword" datatype="*" nullmsg="请输入旧密码！"></td>
                      </tr>
                      <tr>
...
(function($){
	...
	$(".inputform").Validform({
		...
		callback:function(data){
			var saveNewPasswordURL = "../omsUser/saveNewPassword.html";
