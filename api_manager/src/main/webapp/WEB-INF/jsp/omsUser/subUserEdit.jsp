            ...
            <div class="add-user">
                <table border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td><input name="telPhone" type="text" class="input_text pp" value="${omsUserBean.telPhone }" maxlength="20"></td>
                  </tr>
                  <tr>
                 ...
                 <!--  <tr>
                    ...
                    <td><input name="password" type="password" class="input_text pp" datatype="s6-20" nullmsg="请输入密码！" errormsg="密码至少由6位字符组成！"></td>
                  </tr>
                  <tr>
                    <td align="right"><Span class="red">*</Span> 再次输入密码：</td>
                    <td><input name="repassword" type="password" class="input_text pp" datatype="s6-20" recheck="password" nullmsg="请再次输入密码！" errormsg="您两次输入的账号密码不一致！"></td>
                  </tr> -->
                </table>
            </div>
            <br/>
