            ...
            <div class="add-user">
                <table border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td><input name="userAccount" maxlength="15" type="text" class="input_text pp" value="${omsUserBean.userAccount }" datatype="EnglishOrNumber" nullmsg="请填写帐号！" errormsg="账号由字符或数字组成！"></td>
                  </tr>
                  <tr>
