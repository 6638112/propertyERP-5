...
<div class="info">
    <h2>账号配置</h2>
        <form class="inputform" name="saveForm" action="<%=basePath%>/omsUser/saveSubUser.html" method="post">
    <div class="distr">
        <div class="bs-example">
            ...
            <div class="add-user">
                <table border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td align="right"><Span class="red">*</Span> 账号名称：</td>
                  ...
                  <tr>
                    ...
                    <td><input name="telPhone" type="text" class="input_text pp" maxlength="20"></td>
                  </tr>
                  <tr>
                    <td align="right"><Span class="red">*</Span> 账号：</td>
                    <td><input name="userAccount" maxlength="15" type="text" class="input_text pp" value="${omsUserBean.userAccount }" datatype="EnglishOrNumber" nullmsg="请填写账号！" errormsg="账号由字符或数字组成！"></td>
                  </tr>
                  <tr>
                    <td align="right"><Span class="red">*</Span> 密码：</td>
                    <td><input name="password" type="password" class="input_text pp" value="${omsUserBean.password }" datatype="s6-20" nullmsg="请输入密码！" errormsg="密码由6位到至20位字符组成！"></td>
                  </tr>
                  <tr>
            ...
            <display:table name="omsRoles" id="row" class="mars info-list-02 mtop20" >
				<display:column title="选择">
					...
					<input type="checkbox" value="${row.id }" name="roleId" />
				</display:column>
