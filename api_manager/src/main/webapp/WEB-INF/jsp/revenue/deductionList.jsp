...
<div class="info">
    ...
    <form id="searchForm" name="form_main" action="<%=basePath%>/finance/deductionList.html" method="post">
        <table class="info-list" border="0">
          <tr>
            <td width="5%"><div align="right">物业公司：</div></td>
            ...
            <td width="15%"><input class="input_text w120 pp" type="text" name="residential" value="${param.residential}" /></td>
            <td width="10%"><div align="right">栋楼：</div></td>
            <td width="20%"><input class="input_text w120 pp" type="text" name="residential" value="${param.building}" /></td>
          </tr>
          <tr>
            <td><div align="right">单元门牌号：</div></td>
            <td><input class="input_text w120 pp" type="text" name="roomNum" value="${param.roomNum}" /></td>
          	<td><div class="list-name">抵扣日间：</div></td>
          ...
          <tr>
          	<td colspan="2">抵扣物业费金额总计：<fmt:formatNumber value="${financeSum.wyMoney }" pattern="#,##0.##"/></td>
	    ...
	    <display:table name="deductionList" id="row" class="info-list-02 mtop20" cellpadding="0" cellspacing="1" pagesize="<%=OmsSysParamManager.getOmsSysParaValue(OmsSysParamKey.PageNum) %>" requestURI="" partialList="true" size="resultSize">
			<%--
			...
			<display:column title="投资金额" property="deductionPrice2" sortable="true" format="{0, number, 0.##}"/>
			<display:column title="抵扣时间" property="deductionTm" sortable="true" format="{0, date, yyyy-MM-dd}" />
		</display:table>
