...
<div class="info">
    ...
    <div class="bs-example bgebeb">
    	<form method="post" action="../groupBuilding/searchAudit.html">
	           ...
	           <tr>
	            ...
	            <td>
					<select name="auditStatus" class="select_normal w131">
	                    ...
	                    <option value="0" <c:if test="${not empty param.auditStatus and param.auditStatus==0 }"> selected="selected"</c:if>>待审核</option>
    ...
    <display:table name="resList" uid="row" id="row" class="mars info-list-02 mtop20" pagesize="10" requestURI="" partialList="true" size="resultSize" >
		...
		<display:column title="操作" >
			<c:if test="${row.checkStatus==0 }"><a class="blue" name="view" href="../groupBuilding/initAudit.html?id=${row.id }">审核</a></c:if>
