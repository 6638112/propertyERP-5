...
<div class="info">
    ...
    <div class="distr">
        <div class="bs-example">
            <ul class="ranking">
            	<form action="../channelPartner/search.html" method="post">
	            	<li>姓名： <input type="text" name="name" class="input_text" palceholder="请输入姓名"></li>
	            	<li>联系号码： <input type="text" name="phone" class="input_text" palceholder="请输入联系号码"></li>
	            	<li>用户名： <input type="text" name="omsUserName" class="input_text" palceholder="请输入用户名"></li>
			...
			<display:table name="resList" id="row" class="info-list-02 mtop20"	pagesize="<%=OmsSysParamManager.getOmsSysParaValue(OmsSysParamKey.PageNum) %>" requestURI="" partialList="true" size="resultSize">
				...
				<display:column title="身份证号" property="idNumber" />
