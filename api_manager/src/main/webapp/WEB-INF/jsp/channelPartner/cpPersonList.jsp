...
<div class="info">
    ...
    <div class="distr">
        <div class="bs-example">
            <ul class="ranking">
            	<form action="../channelPartner/searchCPPerson.html" method="post">
	            	<li>姓名： <input type="text" name="name" value="${name}" class="input_text pp" palceholder="请输入姓名"></li>
			...
			<display:table name="resList" id="row" class="info-list-02 mtop20"	pagesize="<%=OmsSysParamManager.getOmsSysParaValue(OmsSysParamKey.PageNum) %>" requestURI="" partialList="true" size="resultSize">
				...
				<display:column title="邀请码" property="inviteCode" />
				<display:column title="指定跟进人" property="inviteName" />
