...
<div class="main posrelative resetmain">
    <div class="info w960">
        <form  id="inputForm" class="inputform" action="../channelPartner/saveCompany.html" method="post">
        <h2>渠道注册</h2>
                ...
                <div class="add-user">
                    <table border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        ...
                        <td><input type="text" maxlength="15" class="input_text pp" name="omsUserName" value="" datatype="EnglishOrNumber" nullmsg="请输入登录账号！" errormsg="登录账号由字母或数字组成！" onchange="validateUserName(this);">用来登录解放区后台系统</td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td><input type="text" class="input_text pp" name="cname" value="" /></td>
                      </tr>
        ...
        <div class="distr step04 dsn">
            <div class="bs-example">
                <div class="add-user">
                	<div class="t_center f14">您的注册已成功提交！解放区工作人员将在3个工作日内把审核结果发送至您的手机，请注意查收，谢谢！<br/>您可以登录 <a class="blue" href="http://www.jiefangqu.com/oos" target="_blank">解放区物业管理后台</a></div>
                </div>
            </div>
        </div>
        </form>
