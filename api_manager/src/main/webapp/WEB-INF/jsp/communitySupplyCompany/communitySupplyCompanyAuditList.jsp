...
<div class="info">
    ...
    <div class="bs-example bgebeb">
    	<form action="${pageContext.request.contextPath}/communitySupplyCompany/auditSearch.html">
    ...
    <display:table name="resList" id="row" class="info-list-02 mtop20" cellpadding="0" cellspacing="1" pagesize="10" requestURI="" partialList="true" size="resultSize">
		...
		<display:column title="操作" >
			<a class="blue editShopInfo" href="${pageContext.request.contextPath}/communitySupplyCompany/auditView.html?id=${row.tCommunitySupplyFId }&tmpId=${row.id}">查看</a>
			<c:if test="${row.auditStatus==1 }">
		        <a class="blue checkShopInfo auditHref" href="${pageContext.request.contextPath}/communitySupplyCompany/initAudit.html?id=${row.tCommunitySupplyFId }&tmpId=${row.id}">审核</a>
			</c:if>
		</display:column>
	</display:table>
</div>
