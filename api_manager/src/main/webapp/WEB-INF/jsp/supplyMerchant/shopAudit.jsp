...
<body>
<div class="info">
	<form id="inputform" class="inputform" action="saveEsmAudit.json" method="post" onsubmit="return false;">
        ...
        <h2 class="mtop20">运营账户：</h2>
        <tr>
            <td align="right">是否添加运营后台账户：</td>
            <td>
                <input type="radio" name="isAddOmsUser" value="1"> 添加
                <input type="radio" name="isAddOmsUser" value="0"> 不添加
            </td>
        </tr>
        ...
        <div class="bs-example">
            <table class="info-list" border="0">
              <tr>
                ...
                <td colspan="5"><select name="auditResult" class="select_normal w131 select-check-box">
                            <option value="pass">通过</option>
                            <option value="notpass">不通过</option>
                            </select></td>
              </tr>
                <tr class="swap-info swap-val-pass">
                    <td align="right"><div class="grey">佣金比例：</div></td>
                    <td><input type="text" name="revenueRate" maxlength="5" class="input_text w80" ignore="ignore" datatype="numberFixTwoSmallThanHundred" nullmsg="请填写佣金比例！" /> %</td>
                </tr>
              <tr class="swap-info swap-val-notpass dsn">
                <td align="right"><span class="grey">原因：</span></td>
                <td colspan="5"><textarea name="auditDesc" class="textareas txt02" name="" cols="" rows="5" datatype="*4-100" nullmsg="审核结果为“不通过”时需填写原因！" errormsg="原因范围为4到100个字！"></textarea></td>
              </tr>
            </table>
        </div>
        <div class="padb mtop10"><input id="checkShopList" class="info-btn" type="submit" value="提 交" /></div>
    </form>
</div>
</body>
...
$(function(){
    ...
    selectOptionChange('.select-check-box');
