...
public class CommunitySupplyEntity extends CommunitySupply {
	 ...
	 * 推荐记录解放区审核状态
	 */
	int pscAuditStatus = 0;

	public int getPscAuditStatus() {
		return pscAuditStatus;
	}

	public void setPscAuditStatus(int pscAuditStatus) {
		this.pscAuditStatus = pscAuditStatus;
	}
