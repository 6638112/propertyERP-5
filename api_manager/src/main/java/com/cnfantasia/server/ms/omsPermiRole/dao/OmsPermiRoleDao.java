...
public class OmsPermiRoleDao extends AbstractBaseDao implements IOmsPermiRoleDao {
	...
	public List<DistrictManager> getDistrictManagerList(Map<String, Object> paramMap) {
		return sqlSession.selectList("omsPermiRole.select_district_manger_list", paramMap);
	}
    ...
    public List<Map<String, Object>> getOmsUserList(String qryStr, PageModel pageModel) {
        ...
        return sqlSession.selectList("omsPermiRole.getOmsUserList", param);
    }
	
	@Override
	public void deleteByDistrictId(BigInteger districtId) {
//		sqlSession.update("omsPermiRole.deleteByDistrictId", districtId);
		sqlSession.delete("omsPermiRole.deleteByDistrictId", districtId);
	}
	
	@Override
	public void deleteGbByDistrictId(BigInteger districtId) {
		sqlSession.delete("omsPermiRole.deleteGbByDistrictId", districtId);
	}
}
