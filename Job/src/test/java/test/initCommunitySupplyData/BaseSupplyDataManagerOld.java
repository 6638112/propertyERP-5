/**   
* Filename:    BaseSupplyDataManagerOld.java   
* @version:    1.0  
 ...
 * 2014年9月17日       shiyl             1.0             1.0 Version
 */
public class BaseSupplyDataManagerOld  extends BaseTest{
	/**是否连接数据库获取数据*/
	public static final boolean connect2Db = true;
	/**是否校验数据*/
	public static final boolean throwException = true;
	/**是否插入数据库*/
	public static final boolean insertBath = false;
...
//				t_GroupBuilding_initId = new BigInteger("5000");//3200-4858,5000~7102
...
//		}
	 ...
	 * @return
	 */
	public BigInteger getIdByCommunitySupplyTypeName(String name){
		for(CommunitySupplyType tmpCommunitySupplyType:communitySupplyTypeList){
	 ...
	 * @return
	 */
	public BigInteger getIdByCommunitySupplyName(String name){
		for(CommunitySupply tmpCommunitySupply:communitySupplyList){
	 ...
	 * @return
	 */
	public BigInteger getIdByAddressCityName(String name){
	 ...
	 * @return
	 */
	public BigInteger getIdByAddressBlockSelfDefinedName(String name){
		for(AddressBlockSelfDefined tmpAddressBlockSelfDefined:addressBlockSelfDefinedList){
	 ...
	 * @return
	 */
	public BigInteger getIdByGroupBuildingName(String name){
		for(GroupBuilding tmpGroupBuilding:groupBuildingList){
	 ...
	 * @return
	 */
	public BigInteger getIdByAddressBlockName(String name){
