...
<link type="text/css" rel="stylesheet" href="css/falling.css?v=1.0.2">
</head>
<body>
<div id="container"> 
    <%-- <div class="gift dsn">
     ...
     <div class="gift dsn">
    	<div class="gift-txt opacity0"><span class="orange t01">哇塞！意外惊喜！</span><br/><span class="t02">恭喜获得</span><span class="orange t02">${hbAmount}元消费券</span></div>
    	<div class="gift-img giftBtn"><span class="gift-num dsn">￥${hbAmount}<br><span class="f01">解放区消费券</span></span><div class="pic"><img class="gf" src="images/xiaofeiquan.png" /><img class="lightbg animated5s infinite rotateOut01 dsn" src="images/lightbg.png" /></div></div>
    	<div class="gift-btn dsn"><input class="giftBtn" type="button" value="领取消费券" onclick="claimMoney();" /></div> 
        <ul class="share-info dsn">
        	<li class="bold">已领取消费券<br>分享还有再抢的机会哦~</li>
        	<li class="share-btn"><a href="javascript:void(0)" target="_blank"><img src="images/share-icon.png" /><br>微信朋友圈</a></li>
        </ul>
...
<script type="text/javascript" src="js/jquery.eggs.js?v=1.0.2"></script>
<script type="text/javascript">
	function claimMoney(){
		//alert('领取现金~');
		$.ajax({
