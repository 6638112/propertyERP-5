...
$(function(){
	function setDocHeight(){
		...
		$docum.css('min-height',DocWidth*1020/640);
	}
	setDocHeight();
	$(window).resize(function(){
		setDocHeight();
...
$(function(){
	...
	if(isAndroid){
		...
		$('.share-btn').click(function(){
			window.amazing.giftShare();
		});
	}
	
	//ios
	if(isiOS){
		function giftClose1(cmd,parameter1){
			document.location="jfq://"+cmd+":/"+parameter1;
		};
		
		$('.close-btn').click(function(){
			giftClose1('giftClose','parameter1');
		});
	
		function giftShare1(cmd,parameter1){
			document.location="jfq://"+cmd+":/"+parameter1;
		};
		
		$('.share-btn').click(function(){
			giftShare1('giftShare','parameter1');
		});
	}
