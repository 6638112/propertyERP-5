/**   
* Filename:    PropertyPayController.java   
* @version:    1.0  
* Create at:   2014年11月19日 上午3:07:53   
* Description:  
*   
...
public class PropertyPayController extends AbstractWeiXinPaymentController{
	private static final String payNotifyUrl = "propertyPay/payNotify.json?";
...
//	@Override
	...
	public Map<String, Object> doWeixinPrePay(WeiXinPay_GoalAccType goalAccType,BigInteger userId, BigInteger orderId, String notify_url,
		...
		return weiXinPayService.weixinPrePay(goalAccType,userId, orderId, notify_url, remoteAddr, packageReqHandler, prepayReqHandler, clientHandler);
	}
