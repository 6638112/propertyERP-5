...
//     private int duigong;
//     private int duisi;
//     private int loadcusMgIndex;
//     public int getLoadcusMgIndex() {
//		return loadcusMgIndex;
//	}
//
//	public void setLoadcusMgIndex(int loadcusMgIndex) {
//		this.loadcusMgIndex = loadcusMgIndex;
//	}
//
//	public int getDuigong() {
//		return duigong;
//	}
//
//	public void setDuigong(int duigong) {
...
//	}
//
//	public void setDuisi(int duisi) {
//		this.duisi = duisi;
//	}
//
//	
...
//                if(index==0){
//                	  duigong=datas.size();
//                	  loadcusMgIndex=datas.size();
//                	  //System.out.println("对公长度"+duigong);
//                }
//                if(index==1){
//                	duisi=datas.size()-duigong;
//                	//System.out.println("对私长度"+duisi);
//                }
//                 
//              stream.close();
//              ++index;
...
//      
//        excel.setPath("G:/产品手册及PPT目录（随20121028）.xlsx");
