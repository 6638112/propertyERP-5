...
*/
package com.cnfantasia.server.business.commonBusiness.constant;
...
public class SmallPicUploadConfig {
	...
	public enum BusinessModelType{
		...
		, Dredge(SmallPicUploadConfig.Dredge_guigeList); //疏通服务
	...
	private static final Map<String, WidthHeight> Dredge_guigeList = new HashMap<String, WidthHeight>();//疏通服务
...
//			Community_PingExchang_guigeList.put(new WidthHeight(265,230).getFileName(),new WidthHeight(265,230));
		...
		{
			Dredge_guigeList.put(new WidthHeight(150, 150).getFileName(), new WidthHeight(150, 150));
			Dredge_guigeList.put(new WidthHeight(225, 225).getFileName(), new WidthHeight(225, 225));
		}
	}
	static{
		...
		guigeList.putAll(Dredge_guigeList);
	}
