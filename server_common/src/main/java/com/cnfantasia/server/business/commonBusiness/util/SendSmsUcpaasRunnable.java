 ...
 */
public class SendSmsUcpaasRunnable implements Callable<String>{
	
	private static Log logger = LogFactory.getLog(SendSmsUcpaasRunnable.class);
	
	private List<String> mobiles;
	private String content;
	
	public SendSmsUcpaasRunnable(List<String> mobiles, String content){
...
//		params.put("content", String.format("%s【解放区】", content));
	...
	public static void main(String[] args) throws Exception{
		...
		try{
			FutureTask<String> task = new FutureTask<String>(new SendSmsUcpaasRunnable(mobiles, content));
