package com.cnfantasia.server.ucpaas;
...
import com.cnfantasia.server.business.commonBusiness.util.ConstantsUtil;
...
public class SysConfig {
	...
	public void loadConfigProps() {
		InputStream is = null;
		try {
			is = getClass().getResourceAsStream("/com/cnfantasia/server/business/pub/ucpaas.properties");
			if (is == null) {
				is = getClass().getResourceAsStream("/ucpaas.properties");
			}
