...
//	当前线上的Android ok  1
	...
	//师傅端IOS
//	public static String apikey = "V5Oa0lp9DWa5Ip6EGiFRN5Lp";
//	public static String secret_key = "d418e67b2059a643477b9eae3f97dee9";
...
//		String content = "解放区送神器啦！物业宝免物业费还能赚钱！详询管理处。";//ok
		String content = "菜心底价惊爆上市，蛇口万福佳超市温暖上线！更多惊喜就在解放区社区店，抢先购>>>";
...
//		confList = FileTest.parseFile("C:\\万福佳生活超市周边小区用户百度ID.csv");//ok
		confList.add(new PushConfig(2, "725399635682359694", "5280789176935557029"));//weijian
//		confList.add(new PushConfig(1, "921884034776341394", "3813788578338150773"));
//		confList.add(new PushConfig(1, "3813788578338150773", "921884034776341394"));
//		confList.add(new PushConfig(1, "590323850004648919", "3705809094495745588")); //weijianchang
//		confList.add(new PushConfig(1, "735382220994716671", "3555317778813942409")); //gaofei  boss 非常重要
