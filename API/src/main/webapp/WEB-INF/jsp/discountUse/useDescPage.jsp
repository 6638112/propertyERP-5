...
<link rel="stylesheet" href="../signalStyle/discountUse/css/common.css">
</head>
...
<section class="sectionBox">
   <div class="info pb0">
   		<%if(request.getAttribute("showIndex").equals(2) || request.getAttribute("showIndex").equals(3)){%><div class="user-status">您当前身份</div><%}%>
...
<script src="../signalStyle/discountUse/js/jquery-1.11.2.min.js"></script>
<script src="../signalStyle/discountUse/js/fastclick.js"></script>
<script>
	$(function(){
		new FastClick(document.body);
	});
</script>
<script src="../signalStyle/discountUse/js/exchange.common.js"></script>
