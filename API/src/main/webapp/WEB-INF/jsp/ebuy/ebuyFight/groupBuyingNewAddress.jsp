    ...
    <ul class="register-list">
        <li>
            <div class="displaybox">
                <div class="boxflex01 f16 grey"><input id="bankCardPersonInput" class="input-text wp100 f16" type="text" placeholder="收货人" value="" maxlength="10" datatype="*" nullmsg="请填写收货人！" /></div>
            </div>
        </li>
    </ul>
    <section class="divide-box bordertbgrey"></section>
