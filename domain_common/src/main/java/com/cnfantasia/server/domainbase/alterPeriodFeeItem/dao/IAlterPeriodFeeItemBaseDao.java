 ...
 * 
 */
public interface IAlterPeriodFeeItemBaseDao {
	/**
	 * 根据条件查询(选择周期收费项)信息
	 * @param paramMap
	 ...
	 * @return
	 */
	List<AlterPeriodFeeItem> selectAlterPeriodFeeItemByCondition(Map<String, Object> paramMap, boolean isDim);
	/**
	 * 按条件分页查询(选择周期收费项)信息
	 * @param paramMap
	 * @param pageModel
	 ...
	 * @return
	 */
	List<AlterPeriodFeeItem> selectAlterPeriodFeeItemByCondition(Map<String, Object> paramMap, PageModel pageModel, boolean isDim);
	/**
	 * 根据序列号查询(选择周期收费项)信息
	 * @param id
	 * @return
	 */
	AlterPeriodFeeItem selectAlterPeriodFeeItemBySeqId(java.math.BigInteger id);
	/**
	 ...
	 * @return
	 */
	int selectAlterPeriodFeeItemCount(Map<String, Object> paramMap, boolean isDim);
	/**
	 * 往(选择周期收费项)新增一条记录
