...
/**
 * 描述:(物业公司/管理处/自有平台的支付宝信息) DAO层接口
 * 
 * @version 1.00
 * @author null
 * 
 */
public interface IPropertyCompanyThirdPayCfgBaseDao {
	/**
	 ...
	 * @return
	 */
	List<PropertyCompanyThirdPayCfg> selectPropertyCompanyThirdPayCfgByCondition(Map<String, Object> paramMap, boolean isDim);
	/**
	 ...
	 * @return
	 */
	List<PropertyCompanyThirdPayCfg> selectPropertyCompanyThirdPayCfgByCondition(Map<String, Object> paramMap, PageModel pageModel, boolean isDim);
	/**
	 * 根据序列号查询(物业公司/管理处/自有平台的支付宝信息)信息
	 * @param id
	 * @return
	 */
	PropertyCompanyThirdPayCfg selectPropertyCompanyThirdPayCfgBySeqId(java.math.BigInteger id);
	/**
	 ...
	 * @return
	 */
	int selectPropertyCompanyThirdPayCfgCount(Map<String, Object> paramMap, boolean isDim);
	/**
