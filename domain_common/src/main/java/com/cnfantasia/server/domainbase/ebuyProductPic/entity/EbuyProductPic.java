package com.cnfantasia.server.domainbase.ebuyProductPic.entity;
 ...
 */
/*
public class EbuyProductPic implements Serializable{
*/


public class EbuyProductPic extends BaseEntity{

	private static final long serialVersionUID = 1L;
	/**  */	private BigInteger id;	/** 大图地址 */	private String urlBig;	/** 小图地址 */	private String urlMini;	/**  */	private BigInteger tEbuyProductFId;
	public EbuyProductPic(){
	}
	public EbuyProductPic(EbuyProductPic arg){
	...
	public EbuyProductPic(BigInteger id,String urlBig,String urlMini,BigInteger tEbuyProductFId,String sys0AddTime,String sys0UpdTime,String sys0DelTime,BigInteger sys0AddUser,BigInteger sys0UpdUser,BigInteger sys0DelUser,Integer sys0DelState){
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		EbuyProductPic other = (EbuyProductPic) obj;
