package com.cnfantasia.server.domainbase.collections.entity;
...
public class Collections extends BaseEntity{
	...
	public Collections(Collections arg){
	...
	public Collections(BigInteger id,BigInteger userId,String time,Integer targetType,BigInteger targetId,String sys0AddTime,String sys0UpdTime,String sys0DelTime,BigInteger sys0AddUser,BigInteger sys0UpdUser,BigInteger sys0DelUser,Integer sys0DelState){
