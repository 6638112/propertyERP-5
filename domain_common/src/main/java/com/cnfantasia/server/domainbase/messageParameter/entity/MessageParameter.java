package com.cnfantasia.server.domainbase.messageParameter.entity;
...
public class MessageParameter extends BaseEntity{
	...
	public MessageParameter(MessageParameter arg){
	...
	public MessageParameter(BigInteger id,BigInteger tMessageFId,String key,String value,String sys0AddTime,String sys0UpdTime,String sys0DelTime,BigInteger sys0AddUser,BigInteger sys0UpdUser,BigInteger sys0DelUser,Integer sys0DelState){
